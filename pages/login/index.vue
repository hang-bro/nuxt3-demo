      ...
      >
        ...
        <el-form-item>
          <div class="flex w-full justify-between">
            <div>
              <input type="checkbox" :checked="checked" /><span class="ml-2">记住密码</span>
            </div>
            <a href="/resetPassword" class="text-[#1e80ff] font-bold">忘记密码?</a>
          </div>
        </el-form-item>
        <el-form-item>
        ...
        <el-form-item>
          <div class="text-sm text-gray-500">
            没有账号?
            <a @click="navigateTo('/register')" class="font-semibold leading-6 text-indigo-600">
              点击注册
            </a>
          </div>
        </el-form-item>
